...
class AppComponentInjector implements AppComponent {
  ...
  _i8.SplashModule _createSplashModule() {
    ...
    return _i8.SplashModule(_i7.SplashScreen(
      spalshAnimationBloC: spalshAnimationBloC,
    ));
  }

  _i4.DetectionModule _createDetectionModule() {
    final _i1.CameraCubit cameraBloc =
        _i1.CameraCubit(mediator: mediatorSingleton);
    final _i3.ObjectDetectionCubit objectDetectionCubit =
        _i3.ObjectDetectionCubit(mediator: mediatorSingleton);
    return _i4.DetectionModule(
        _i6.ObjectSelectionScreen(),
        _i5.DetectorScreen(
